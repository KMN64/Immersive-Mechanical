...
public class INESolidFluid extends FlowingFluid {
	  public static final Collection<INESolidFluid> INESOLID_FLUIDS = new ArrayList<>();
	  
	  protected final String fluidName;
	  
	  protected final ResourceLocation stillTex;
	  protected final ResourceLocation flowingTex;
	  protected INESolidFluid flowing;
	  protected INESolidFluid source;
	  @Nullable
	...
	protected INESolidFluid(String fluidName, ResourceLocation stillTex, ResourceLocation flowingTex, @Nullable Consumer<FluidAttributes.Builder> buildAttributes) 
	{ 
		this(fluidName, stillTex, flowingTex, buildAttributes, true);
	}
	
	protected INESolidFluid(String fluidName, ResourceLocation stillTex, ResourceLocation flowingTex, @Nullable Consumer<FluidAttributes.Builder> buildAttributes, boolean isSource) {
	  ...
	  protected INESolidFluid createFlowingVariant() {
	    INESolidFluid ret = new INESolidFluid(this.fluidName, this.stillTex, this.flowingTex, this.buildAttributes, false)
	      {
