...
public abstract class INEMultiblockRecipe extends MultiblockRecipe{
	Lazy<Integer> totalProcessTime;
	Lazy<Integer> totalProcessEnergy;
	protected INEMultiblockRecipe(ItemStack outputDummy, IRecipeType<?> type, ResourceLocation id){
