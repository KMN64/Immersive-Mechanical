...
public class INEFluid extends FlowingFluid {
	  public static final Collection<INEFluid> INE_FLUIDS = new ArrayList<>();
	  
	  protected final String fluidName;
	  
	  protected final ResourceLocation stillTex;
	  protected final ResourceLocation flowingTex;
	  protected INEFluid flowing;
	  protected INEFluid source;
	  @Nullable
	...
	protected INEFluid(String fluidName, ResourceLocation stillTex, ResourceLocation flowingTex, @Nullable Consumer<FluidAttributes.Builder> buildAttributes, boolean isSource) {
	  ...
	  protected INEFluid createFlowingVariant() {
	    INEFluid ret = new INEFluid(this.fluidName, this.stillTex, this.flowingTex, this.buildAttributes, false)
	      {
